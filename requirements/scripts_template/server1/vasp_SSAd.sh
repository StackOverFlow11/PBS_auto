...
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vasp_std_SSAd > stdout 2>&1
mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vasp_gam_SSAd > stdout 2>&1
#########################################
