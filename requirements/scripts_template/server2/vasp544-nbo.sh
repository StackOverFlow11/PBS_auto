...
#----------------------------------------------------------------------
vasp_gam="/share/apps/vasp/vasp544-nbo/bin/vasp_gam"
vasp_std="/share/apps/vasp/vasp544-nbo/bin/vasp_std"
export PATH=/share/apps/vasp/NBO/projection:$PATH
export PATH=/share/apps/vasp/NBO/periodic_nbo:$PATH
